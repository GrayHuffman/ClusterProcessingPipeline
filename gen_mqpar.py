...
parser.add_argument('-mq', '--mq-version', type=str, default='1_6_3_3', choices=['1_6_2_3', '1_6_2_10', '1_6_3_2', '1_6_3_3','1_6_7_0'], help='MaxQuant version')
...
# replace fasta path
fasta_path = '/home/huffman.r/FASTA/SwissProt_human_09042017.fasta'
...
output_folder = ('/scratch/huffman.r/' + output_folder)
...
'source /home/huffman.r/.bashrc\n'
'srun mono ${MQ_VERSION} {MQPAR}\n'
'mkdir /scratch/huffman.r/SearchResults_forGDrive/{JOBNAME}\n'
'cp -a /scratch/huffman.r/{JOBNAME}/combined/txt/. /scratch/huffman.r/SearchResults_forGDrive/{JOBNAME}/\n'
)
